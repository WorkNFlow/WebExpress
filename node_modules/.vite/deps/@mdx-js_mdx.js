...
function element(node2, state) {
  ...
  for (property in properties) {
    if (own2.call(properties, property)) {
      ...
      if (property === "style") {
        ...
        for (cssProperty in styleObject) {
          if (own2.call(styleObject, cssProperty)) {
            cssProperties.push({
              type: "Property",
              method: false,
              shorthand: false,
...
function inherit(from, to) {
  ...
  if (left) {
    for (key2 in left) {
      if (own5.call(left, key2) && key2 !== "estree") {
        if (!right) right = {};
...
function mdxExpression2(options) {
  ...
  function tokenizeFlowExpression(effects, ok3, nok) {
    ...
    function after(code2) {
      return markdownSpace(code2) ? factorySpace(effects, end, types2.whitespace)(code2) : end(code2);
    }
    function end(code2) {
  ...
  function tokenizeJsxFlow(effects, ok3, nok) {
    ...
    function end(code2) {
      ...
      return code2 === codes.lessThan ? (
        ...
        start2(code2)
      ) : code2 === codes.leftCurlyBrace && expression ? effects.attempt(expression, end, nok)(code2) : code2 === codes.eof || markdownLineEnding(code2) ? ok3(code2) : nok(code2);
    }
  }
}
...
function subcontent(events, eventIndex) {
  ...
  while (current2) {
    ...
    ok(
      !previous2 || current2.previous === previous2,
      "expected previous to match"
    );
    ok(!previous2 || previous2.next === current2, "expected next to match");
...
function tokenizeHtmlText(effects, ok3, nok) {
  ...
  function commentEnd(code2) {
    return code2 === codes.greaterThan ? end(code2) : code2 === codes.dash ? commentClose(code2) : comment2(code2);
  }
  function cdataOpenInside(code2) {
    const value = constants.cdataOpeningString;
    if (code2 === value.charCodeAt(index2++)) {
...
function resolveAllLabelEnd(events) {
  ...
  while (++index2 < events.length) {
    ...
    if (token.type === types2.labelImage || token.type === types2.labelLink || token.type === types2.labelEnd) {
      const offset2 = token.type === types2.labelImage ? 4 : 2;
...
function tokenizeListStart(effects, ok3, nok) {
  ...
  function start2(code2) {
    ...
    const kind = self2.containerState.type || (code2 === codes.asterisk || code2 === codes.plusSign || code2 === codes.dash ? types2.listUnordered : types2.listOrdered);
    if (kind === types2.listUnordered ? !self2.containerState.marker || code2 === self2.containerState.marker : asciiDigit(code2)) {
...
function tokenizeIndent(effects, ok3, nok) {
  ...
  function afterPrefix(code2) {
    ok(self2.containerState, "expected state");
    const tail = self2.events[self2.events.length - 1];
    return tail && tail[1].type === types2.listItemIndent && tail[2].sliceSerialize(tail[1], true).length === self2.containerState.size ? ok3(code2) : nok(code2);
  }
}
...
function resolveToSetextUnderline(events, context) {
  ...
  events[text5][1].type = types2.setextHeadingText;
  if (definition2) {
...
function defaultUnknownHandler(state, node2) {
  ...
  const result = "value" in node2 && !(own9.call(data2, "hProperties") || own9.call(data2, "hChildren")) ? { type: "text", value: node2.value } : {
    type: "element",
    tagName: "div",
    properties: {},
    children: state.all(node2)
...
var Processor = class _Processor extends CallableInstance {
  ...
  data(key2, value) {
    if (typeof key2 === "string") {
      ...
      return own10.call(this.namespace, key2) && this.namespace[key2] || void 0;
    }
    if (key2) {
      assertUnfrozen("data", this.frozen);
      this.namespace = key2;
